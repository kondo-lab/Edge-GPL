...
/*
	...
	Function: Sends a request to run centrality analysis algorithm
		to the server. Receives the operation status and list of
		vertices with the highest centrality from server.
	Input: none
*/
namespace Client {
STATUS centrality_analysis(socket_info *arg, string *list)
{
	...
	STATUS status = SUCCESS, // Marks whether the requested operation was successful
	       ack = FAIL;
	COMMAND command = CMD_CENTRALITY_ANALYSIS;
