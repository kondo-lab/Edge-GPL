...
/*
	...
	Function: Sends a request to retrieve all available graph formats.
		Receives the list of available formats from server.
	Input: none
*/
namespace Client {
STATUS list_graph_formats(socket_info *arg, string *formats)
{
	...
	STATUS status = SUCCESS, // Marks whether the requested operation was successful
	       ack = FAIL;
	COMMAND command = CMD_LIST_GRAPH_FORMATS;
