...
/*
	Name: run_dfs
	Function: Sends a request to run DFS algorithm along with relevant data
		to the server.
		Receives the operation status and list of vertices traversed by DFS
		from server.
	Input: Name of the DFS root vertex.
*/
namespace Client {
STATUS run_dfs(socket_info *arg, string name, string *vertexlist, string *edgelist)
{
