...
- Folder structure:
    - The 'include' folder contains the library headers:
        - graph_algorithms.h: contains function declarations for the respective .cpp file's functions as well as some helper structs for the 
                              BGL algorithms.
        ...
        - socket.h: contains struct definitions for pthread arguments as well as function declarations for the respective .cpp file's 
                    functions.
        - graph_edge_list.h: contains function declarations for the respective .cpp file's functions as well as a helper function for the 
                             BGL algorithms.
